...
<div class="container-fluid homepagebackground">
<nav class="navbar navbar-expand-lg navbar-light shadow">
    <div class="container">
        <a class="navbar-brand" href="#"><span class="fa fa-ambulance"></span> Machine Learning Diabetes Project</a>
...
def init_dashboard(server):
    ...
    feature_heatmap_fig = px.imshow(df.corr(), color_continuous_scale=px.colors.sequential.Bluyl)
    ...
    feat_importance_fig = px.bar(feature_importance,
                                 labels={'value': 'Importance', 'index': 'Features'},color_discrete_sequence =['#6BC1A1']*len(df))
